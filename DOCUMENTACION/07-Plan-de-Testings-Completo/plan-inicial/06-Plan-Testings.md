# 06-Plan-Testings — Plan de Testings Profesional Completo
...
### 3.1 Motor de Sorteos (`api/src/lib/verificacion.ts`)
...
### 3.2 Deduplicación (`api/src/lib/sorteos-service.ts`)
...
| B-09 | `api/src/lib/sorteos-service.ts` | 46 | Deduplicación inconsistente (comentario sin `toLowerCase()`) | Media |
